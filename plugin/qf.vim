...
nnoremap <silent> <Plug>QfCprevious      :<C-u> call qf#wrap#WrapCommand('up', 'c')<CR>
nnoremap <silent> <Plug>QfCnext          :<C-u> call qf#wrap#WrapCommand('down', 'c')<CR>
nnoremap <silent> <Plug>QfLprevious      :<C-u> call qf#wrap#WrapCommand('up', 'l')<CR>
nnoremap <silent> <Plug>QfLnext          :<C-u> call qf#wrap#WrapCommand('down', 'l')<CR>
nnoremap <silent> <Plug>QfCtoggle        :<C-u> call qf#toggle#ToggleQfWindow(0)<CR>
nnoremap <silent> <Plug>QfLtoggle        :<C-u> call qf#toggle#ToggleLocWindow(0)<CR>
